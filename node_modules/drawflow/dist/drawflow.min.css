...
.drawflow .drawflow-node{display:flex;align-items:center;position:absolute;background:#0ff;width:160px;min-height:40px;border-radius:4px;border:2px solid #000;color:#000;z-index:2;padding:15px}
.drawflow .drawflow-node.selected{background:red}
...
.drawflow .connection .main-path{fill:none;stroke-width:5px;stroke:#4682b4;transform:translate(-9999px,-9999px)}
...
.drawflow .selectbox rect{fill:#00f;opacity:.5;stroke:#ff0;stroke-width:5;stroke-opacity:.5;transform:translate(-9999px,-9999px)}
...
:root {
  ...
  --dfNodeSelectedBoxShadowBR: 7px;
  --dfNodeSelectedBoxShadowS: 1px;
  --dfNodeSelectedBoxShadowColor: rgba(31, 31, 31, 1);
  ...
  --dfInputHoverBackgroundColor: rgba(222, 222, 222, 1);
  ...
  --dfOutputHoverBackgroundColor: rgba(222, 222, 222, 1);
  --dfOutputHoverBorderSize: 2px;
  --dfOutputHoverBorderColor: #000000;
  --dfOutputHoverBorderRadius: 50px;

  --dfLineWidth: 3px;
  --dfLineColor: rgba(89, 88, 88, 1);
  --dfLineHoverColor: #4682b4;
  --dfLineSelectedColor: rgba(7, 230, 158, 1);
