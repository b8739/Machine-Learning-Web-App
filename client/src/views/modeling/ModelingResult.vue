<template>
  <div>
    ...
    <v-container fluid>
      ...
      <!-- dialog -->
      <v-dialog v-model="modelSaveDialog" persistent max-width="400px">
        <v-card>
          <v-container fluid>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn @click="showModelSaveDialog(false)" color="gray darken-1" text>
                Close
              </v-btn>
              <v-btn @click="saveModelCase('unnamed')" color="blue darken-1" text>
                Confirm
              </v-btn>
            </v-card-actions>
          </v-container>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      modelSaveDialog: state => state.modelingData.modelSaveDialog,
