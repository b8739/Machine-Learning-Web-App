      ...
      function updateData(vm) {
        let dataSource = {
          ...
          getRows: function(params) {
            ...
            let graphSelectModel;
            if (vm.graphSelectModel[vm.gridID] != undefined) {
              graphSelectModel = vm.graphSelectModel[vm.gridID];
            } else {
              graphSelectModel = [];
            }

            // axios
            let path = "http://localhost:8000/datasets/" + vm.datasetToLoad;
            ...
            axios({
              ...
              data: {
                ...
                graphSelectModel: graphSelectModel,
