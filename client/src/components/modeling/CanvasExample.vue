...
export default {
  ...
  methods: {
    ...
    buildAlgorithmNodes() {
      // Node type 생성
      const algorithmNode = new NodeBuilder("Algorithm")
        .setName("Algorithm")
        ...
        .addOption(
          ...
          "ButtonOption",
          () => {
            return { parameterKeys: this.xgboost_parameters };
          },
          "ParameterSidebar"
        )
        .addOption(
          ...
          "ButtonOption",
          () => {
            return { parameterKeys: this.svr_parameters };
          },
          "ParameterSidebar"
        )
        .addOption(
          ...
          "ButtonOption",
          () => {
            return { parameterKeys: this.rf_parameters };
          },
          "ParameterSidebar"
        )
      ...
      this.editor.registerNodeType("Algorithm", algorithmNode, category);

      //Add Algorithm Node
      let algorithmNode2 = new algorithmNode();
      this.editor.addNode(algorithmNode2);
      algorithmNode2.position = { x: 1000, y: 330 };
    },
    async runModel() {
