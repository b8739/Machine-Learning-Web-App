...
const actions = {
  insertRow({ commit, state, getters, rootState }) {
    let path = "http://localhost:8000/insertRow";
  ...
  deleteRow({ commit, state, getters, rootState }) {
    let path = "http://localhost:8000/deleteRow";
    axios({
      method: "post",
      url: path,
      data: {
  ...
  updateRow({ commit, state, rootState }) {
    let path = "http://localhost:8000/updateRow";
  ...
  infiniteLoadingCreated({ commit, state, rootState }) {
    let api = "http://localhost:8000/infiniteLoading";
    axios
      .get(api, {
        params: {
          limit: state.limit
